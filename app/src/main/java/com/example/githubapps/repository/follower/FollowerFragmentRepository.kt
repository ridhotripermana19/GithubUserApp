package com.example.githubapps.repository.follower
...
class FollowerFragmentRepository(private val application: Application) {
    ...
    fun getFollowers(follower: String) {
        ...
        service.getFollower(follower).enqueue(object: Callback<List<UserResponse>> {
