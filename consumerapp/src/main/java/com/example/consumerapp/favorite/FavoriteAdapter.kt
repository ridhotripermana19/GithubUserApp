...
import com.example.consumerapp.utils.customClickListener.CustomOnItemClickListener
import com.example.consumerapp.view.favorite.FavoriteDetails
                    ...
                    CustomOnItemClickListener(
                        ...
                        object : CustomOnItemClickListener.OnItemClickCallback {
                            override fun onItemClicked(view: View, position: Int) {
                                ...
                                activity.startActivityForResult(intent, FavoriteDetails.REQUEST_DETAIL)
                            }
                        })
                )
            }
